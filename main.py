...
\033[0m""")
	...
	while True:
		sys.stdout.write(f"\x1b]2;[\] BATOSAI-CNC :: Online Users: [1] :: Attack Sended: [1/10]\x07")
		sin = input("\033[0;30;46mrootX34@Batosaicnc\x1b[1;37m\033[0m:~# \x1b[1;37m\033[0m")
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			main()
